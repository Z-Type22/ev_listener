...
const (
	...
	Health_Ready_FullMethodName = "/auth.Health/Ready"
)
...
type HealthClient interface {
	...
	Ready(ctx context.Context, in *HealthReadyRequest, opts ...grpc.CallOption) (*HealthReadyResponse, error)
}
...
func (c *healthClient) Ready(ctx context.Context, in *HealthReadyRequest, opts ...grpc.CallOption) (*HealthReadyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthReadyResponse)
...
type HealthServer interface {
	...
	Ready(context.Context, *HealthReadyRequest) (*HealthReadyResponse, error)
...
func (UnimplementedHealthServer) Ready(context.Context, *HealthReadyRequest) (*HealthReadyResponse, error) {
...
func _Health_Ready_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServer).Ready(ctx, req.(*HealthReadyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
